...
class PerimeterSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['message'] = [
      '#type' => 'html_tag',
      '#tag' => 'h3',
      '#value' => $this->t('Perimeter will ban any user that generates "404 - File not found" for requesting any of the following url pattern'),
    ];
    $form['not_found_exception_patterns'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Ban URL patterns'),
